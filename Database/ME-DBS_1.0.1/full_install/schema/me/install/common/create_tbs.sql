...
begin
		...
		la_tb_spaces(1).data_file := '/u01/app/oracle/product/12.1.0.2/db_1/dbs/me_common_data';
		
		
		la_tb_spaces(2).tbs_name := 'me_common_index';
		la_tb_spaces(2).tbs_size := '512M';
		la_tb_spaces(2).data_file := '/u01/app/oracle/product/12.1.0.2/db_1/dbs/me_common_index';
