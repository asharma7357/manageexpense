prompt
prompt Creating table DFP_RSLT_PQ_T1_L1
prompt ============================
prompt
...
begin
	begin
		execute immediate 'drop table DFP_RSLT_PQ_T1_L1 purge';
	exception
		when lv_tbl then
			null;
	end;

	execute immediate 'create global temporary table DFP_RSLT_PQ_T1_L1 (
							TIME_KEY					NUMBER,
							PASS						NUMBER,
	...
	execute immediate 'comment on column DFP_RSLT_PQ_T1_L1.TIME_KEY is ''Time Key value.''';
	execute immediate 'comment on column DFP_RSLT_PQ_T1_L1.PASS is ''Pass number.''';
	execute immediate 'comment on column DFP_RSLT_PQ_T1_L1.REQ_REF_NUM is '' Request Reference Number.''';
	execute immediate 'comment on column DFP_RSLT_PQ_T1_L1.MASTER_DEVICE_ID is ''Master Device Id''';
	execute immediate 'comment on column DFP_RSLT_PQ_T1_L1.REF_NUM is ''Session_id +TimeStamp( As unique Identifier)''';
	execute immediate 'comment on column DFP_RSLT_PQ_T1_L1.SESSION_ID is ''Generated by Java''';
	execute immediate 'comment on column DFP_RSLT_PQ_T1_L1.REC_TYPE is ''Optional''';
	execute immediate 'comment on column DFP_RSLT_PQ_T1_L1.REC_DT is ''sysdate''';
end;
/
