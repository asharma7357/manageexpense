...
begin
		...
		la_tb_spaces(1).tbs_name := '#TBS_DFP_DAT_NAME';
		la_tb_spaces(1).tbs_size := '#TBS_DFP_DAT_SIZE';
		la_tb_spaces(1).data_file := '#ASM_DISKGROUP';
		
		
		la_tb_spaces(2).tbs_name := '#TBS_DFP_IDX_NAME';
		la_tb_spaces(2).tbs_size := '#TBS_DFP_IDX_SIZE';
		la_tb_spaces(2).data_file := '#ASM_DISKGROUP';
